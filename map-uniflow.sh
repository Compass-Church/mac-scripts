...
## Map UniFlow Secure and Delegated queues
    ...
    /usr/sbin/lpadmin -p "SecurePrint" -E -v lpd://$userName@$uniFLOWurl/CanonSecurePrint -P /etc/cups/ppd/SecurePrint.ppd -D "SecurePrint"
    /usr/sbin/lpadmin -p "DelegatedPrint" -E -v lpd://$userName@$uniFLOWurl/DelegatedSecureprint -P /etc/cups/ppd/DelegatedPrint.ppd -D "DelegatedPrint"  
fi