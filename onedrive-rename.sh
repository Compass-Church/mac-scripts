...
#
#
# The OneDrive folder name used in your organization needs to be specified in the script (line 168)
#
# If you want a slightly faster script, at the cost of not making a backup,
# comment out or delete line 218-224 and edit the Jamf notifications at the end.
#
# Changelog
# January 26, 2020
...
function main() {
	...
	local -r onedrivefolder="/Users/""$loggedinuser""/OneDrive - Compass Christian Church"
